...
//alert(cat);
$('#'+id).attr('onkeyup',cat);
$(location).attr('href', 'createorder18.php?category='+cat);
//$('#'+id).attr('onkeyup',cat);
$('#bb').text(cat);
});
...
<select style="color: black;font-size: 15px;" class="form-control" id="menuselect">
  <option>--select--</option>
   <option value="createorder18.php">Create New order</option>
...
<span id="displayarea"  style="border:1px solid black;">
