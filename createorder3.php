...
<table class="table" style="box-shadow: 1px 6px 4px gray;border: none;">
				...
				?>
 					...
 					<td>
 						<?php 
							...
							while ($row=mysqli_fetch_assoc($result)) {
						?>
					<img src="<?php echo $row['imagepath'];?>" height="80" width="80"  class="img-rounded main"   >
					<?php
						}
						?>
 					</td>
...
<table class="table" style="box-shadow: 3px 4px 3px gray;">
